...
template Withdrawal(levels) {
    ...
    // Ensure arithmetic consistency to prevent field wraparound exploits
    // Enforce that existingValue == withdrawnValue + remainingValue
    existingValue === withdrawnValue + remainingValue;
